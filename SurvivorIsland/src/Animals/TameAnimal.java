...
public class TameAnimal extends Animal {
	...
	public TameAnimal(String inName, double[] inLocation, int inHealth, double inWeight) {
		super(inName, inLocation, inHealth, inWeight);
		// TODO Auto-generated constructor stub
	}

	public TameAnimal(String inName, double[] inLocation, MovementType inMoveType, int inHealth, double inWeight) {
